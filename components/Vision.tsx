...
const Vision = () => {
  return (
    <div className="flex justify-center items-center pb-10 ">
      <section className="bg-linear-to-r from-blue-50 via-white to-teal-50 pt-10 sm:pt-16  lg:pb-10 overflow-hidden dark:bg-linear-to-r dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 rounded-3xl max-w-[theme(screens.2xl)] w-[86%] mb-10  ">
          ...
          <div className="lg:flex lg:items-center lg:gap-12 xl:gap-20">
            <div className="lg:w-1/2 mb-12 lg:mb-0 relative z-10">
              <h2 className="text-3xl sm:text-5xl font-extrabold mb-6 sm:mb-8 leading-tight">
                <span className="bg-clip-text text-transparent bg-linear-to-r from-teal-400 to-blue-400 dark:from-teal-300 dark:to-blue-300">
                  Revolutionizing
                </span>
              ...
              <div className="line-clamp-15 sm:line-clamp-[18] space-y-4 sm:space-y-6 text-md sm:text-lg text-gray-700 dark:text-slate-300">
                <p>
                  At VitalSync, we envision a future where healthcare is
            ...
            <div className="lg:w-1/2 relative mt-12 lg:mt-0">
              <div className="absolute inset-0 bg-linear-to-tr from-blue-300 to-teal-300 dark:from-slate-600 dark:to-slate-700 rounded-3xl transform rotate-3 scale-105 z-0 opacity-30 dark:opacity-70"></div>
