...
const AuthHeader = ({ name }: any) => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 bg-white/50 dark:bg-slate-900/50 backdrop-blur-3xl z-50 shadow-xs border-b border-slate-200 dark:border-slate-800">
