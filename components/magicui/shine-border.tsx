      ...
      <div className="p-6 space-y-6 max-w-2xl  ">
        <div className="space-y-4">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white">
            VitalSync: Revolutionizing Hospital Management
          </h2>

          <p className="text-lg text-gray-600 dark:text-gray-400">
            VitalSync is an advanced hospital management system designed to
        ...
        <p className="text-lg text-gray-600 dark:text-gray-400">
          Stay ahead with VitalSync - where technology meets healthcare
          efficiency.
        </p>
      </div>
    </div>
