...
const approaches = [
  ...
  },
  {
    ...
    title: "Security",
    description:
      "Security is a priority at VitalSync. We employ cutting-edge encryption and privacy measures to protect sensitive health data.",
  },
  {
        ...
        <div className="container mx-auto px-4 py-16">
            ...
            {["Our Vision", "Our Mission"].map((title, index) => (
              ...
              >
                ...
                <p className="text-slate-700 dark:text-slate-300 leading-relaxed mb-6">
                  {title === "Our Vision"
                    ? "We envision a future where healthcare is seamlessly connected, universally accessible, and patient-centric. VitalSync aims to create an ecosystem where:"
                    : "VitalSync's mission is to transform healthcare delivery through innovative technology solutions. We are committed to:"}
                </p>
          ...
          <section className="bg-white dark:bg-slate-900 rounded-2xl shadow-2xl p-6 sm:p-10 md:p-12 my-20">
            ...
            <p className="text-lg sm:text-xl text-slate-700 dark:text-slate-300 leading-relaxed text-center max-w-4xl mx-auto mb-12">
              At VitalSync, our approach revolves around creating a seamless,
          ...
          <section className="text-center bg-indigo-800 dark:bg-indigo-800 rounded-2xl p-6 sm:p-10 shadow-2xl">
            ...
            <p className="text-base sm:text-xl text-indigo-100 max-w-2xl mx-auto mb-8">
              At VitalSync, we're always looking for passionate individuals to
