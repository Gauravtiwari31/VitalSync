...
export default function Rooms() {
  ...
  return (
    <div className="min-h-[500px] w-full max-w-[theme(screens.2xl)] flex justify-center py-20 mx-auto bg-linear-to-r dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 ">
