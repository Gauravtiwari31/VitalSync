          ...
          <div className="max-w-5xl mx-auto px-4 md:px-6 py-4">
            ...
            >
              <Input
                ...
                className="flex-1 bg-white/50 dark:bg-slate-800/50 border-slate-200 dark:border-slate-700 focus-visible:ring-amber-500"
                disabled={loading}
              />
              <Button
                type="submit"
        ...
        <AnimatePresence>
          {showScrollTop && (
            <motion.button
              ...
              className="fixed bottom-20 right-4 p-2 rounded-full bg-amber-500 text-white shadow-lg z-50"
              onClick={scrollToTop}
            >
