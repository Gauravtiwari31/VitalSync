...
const ResponseSection = ({
  ...
  className = "",
  expandable = false,
  iconBgClass = "bg-gradient-to-tr from-amber-500 to-orange-500",
}: any) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 className="text-xl font-semibold text-slate-800 dark:text-white flex-1 group-hover:text-amber-600 dark:group-hover:text-violet-400 transition-colors">
          {title}
        </h2>
        {expandable && (
          <motion.div
...
const Message = ({ message, isLast }: any) => {
    ...
    return (
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-slate-700 to-slate-800 flex items-center justify-center shadow-md">
            <User className="h-4 w-4 text-white" />
          </div>
        </div>
        <div className="max-w-[80%] bg-gradient-to-tr from-slate-700 to-slate-800 text-white p-4 rounded-xl shadow-lg">
          {message.content}
        </div>
      </motion.div>
    );
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3">
        <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-amber-500 to-orange-500 flex items-center justify-center shadow-md">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-amber-50 to-slate-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
      ...
      <div className="lg:pl-72 transition-all duration-300">
        {/* Header */}
        <header className="fixed top-0 right-0 left-0 lg:left-72 bg-white/95 dark:bg-slate-950/95 backdrop-blur-xl z-40 border-b border-slate-200 dark:border-slate-700 shadow-sm">
          <div className="max-w-5xl mx-auto px-4 md:px-6 py-3 flex items-center justify-between">
            <div className="flex items-center gap-3">
              <motion.div
                whileHover={{ rotate: 10 }}
                transition={{ duration: 0.2 }}
                className="bg-gradient-to-r from-amber-600 to-orange-600 p-2 rounded-lg shadow-md"
              >
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="px-3 py-1.5 rounded-full bg-gradient-to-r from-violet-100 to-fuchsia-100 dark:from-violet-900/30 dark:to-fuchsia-900/30 text-sm font-medium text-violet-700 dark:text-amber-300 border border-amber-200 dark:border-amber-800/50 shadow-sm flex items-center gap-1.5">
                <Sparkles className="h-3.5 w-3.5" />
                <span>
                  {selectedModel === "curo-beat" ? "Bhura Beats" : "Bhura 1.0 Flash"}
                </span>
              </div>
            </div>
          </div>
            ...
            {messages.length === 0 && (
              <div className="flex flex-col items-center justify-center py-12 text-center">
                <motion.div
                  ...
                  className="w-24 h-24 rounded-full bg-gradient-to-tr from-amber-500 to-orange-500 flex items-center justify-center mb-8 shadow-lg"
                >
            ...
            {messages.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-12 text-center">
                <motion.div
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ duration: 0.5 }}
                  className="w-24 h-24 rounded-full bg-gradient-to-tr from-slate-600 to-slate-700 flex items-center justify-center mb-8 shadow-lg"
                >
                  <Database className="h-12 w-12 text-white" />
                </motion.div>
                <h2 className="text-2xl md:text-3xl font-bold text-slate-800 dark:text-white mb-4 bg-gradient-to-r from-slate-600 to-slate-700 bg-clip-text text-transparent">
                  Bhura 1.0 Flash — Quick Mode
                </h2>
                <p className="text-slate-600 dark:text-slate-300 max-w-xl mb-8 leading-relaxed">
                  Get quick answers to your health questions with Bhura 1.0 Flash.
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-2xl w-full">
                  {[
                    ...
                    >
                      <div className="absolute inset-0 bg-gradient-to-r from-slate-600/0 to-slate-700/0 group-hover:from-blue-500/5 group-hover:to-cyan-500/5 transition-all duration-300"></div>
                      <div className="truncate">{suggestion}</div>
                    </Button>
                  ))}
                </div>
                ...
                <CardContent className="pt-4">
                  <ScrollArea className="h-[calc(100vh-250px)] pr-4">
                    {messages.map((message, index) => (
                      ...
                      >
                        {message.role === "bot" && (
                          <div className="mr-3 flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-tr from-slate-600 to-slate-700 shadow-md">
                        ...
                        {message.role === "user" && (
                          <div className="ml-3 flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-tr from-slate-700 to-slate-800 shadow-md">
        ...
        {/* Input Area */}
        <div className="fixed bottom-0 left-0 right-0 lg:left-72 bg-white/95 dark:bg-slate-950/95 backdrop-blur-xl border-t border-slate-200 dark:border-slate-700 z-40 shadow-lg">
            ...
            >
              <div className="relative flex-1">
                <Input
                  ...
                  className="flex-1 bg-white/50 dark:bg-slate-800/50 border-slate-200 dark:border-slate-700 focus-visible:ring-amber-500 pl-4 pr-12 py-6 shadow-sm rounded-xl"
                  disabled={loading}
                />
                {input.trim() !== "" && (
                  <Button
              ...
              <Button
                ...
                className={`${
                  selectedModel === "curo-beat"
                    ? "bg-gradient-to-tr from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600"
                    : "bg-gradient-to-tr from-slate-600 to-slate-700 hover:from-slate-700 hover:to-slate-800"
