                  ...
                  <Accordion type="single" collapsible className="w-full">
                    ...
                    >
                      <AccordionTrigger className="text-gray-700 dark:text-slate-200">
                        What services does VitalSync offer?
                      </AccordionTrigger>
                      <AccordionContent className="text-gray-600 dark:text-slate-300">
                        VitalSync offers a comprehensive suite of digital
                    ...
                    >
                      <AccordionTrigger className="text-gray-700 dark:text-slate-200">
                        Is my health data secure with VitalSync?
                      </AccordionTrigger>
                      <AccordionContent className="text-gray-600 dark:text-slate-300">
